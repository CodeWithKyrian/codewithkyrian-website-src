<x-admin-layout title="Posts List">
    <x-admin.top-card title="Blog Posts 🤨" subtitle="Here's all the blog posts we have come up with!">
    </x-admin.top-card>
                    ...
                    <table class="table-auto w-full">
                        <thead class="text-xs font-semibold uppercase text-ash-700 bg-ash-100">
                            <tr class="font-semibold text-left">
                                ...
                                <th class="px-2 py-3 whitespace-nowrap">Posted At</th>
                        ...
                        <tbody class="text-sm divide-y divide-ash-100">
                            @foreach ($posts as $post)
                                <tr class="hover:bg-ash-100">
                                    ...
                                    <td class="p-2 whitespace-nowrap">{{ humanize_date($post->posted_at) }}</td>
                                    <td class="p-2 whitespace-nowrap">{{ $post->is_published ? 'Yes' : 'No' }}</td>
                                    <td class="p-2 whitespace-nowrap">
                                        ...
                                        <button @click="confirmDelete({{ $post }}, $dispatch)"
    ...
    <script>
        function modal() {
            return {
                open: false,
                confirmDelete(post, $dispatch) {
                    this.$refs.delete_form.action = route('admin.posts.destroy', post)
                    this.open = true
