<x-admin-layout title="Dashboard">
    <x-admin.top-card title="Good afternoon, {{ auth()->user()->name }} 👋"
        subtitle="Here is what’s happening with your blog this week:">
    </x-admin.top-card>
    <div class="grid grid-cols-12 gap-6">
        <x-admin.dash-card title="New Posts" :count="$posts_count" percent="1.2">
            <x-slot name="icon">
                <svg class="h-16 w-20 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
        ...
        <x-admin.dash-card title="New Comments" :count="$comments_count" percent="-2">
            <x-slot name="icon">
                <svg class="h-16 w-20 text-gray-300" stroke="currentColor" stroke-width="2" fill="none"
        ...
        <x-admin.dash-card title="New Views" :count="$views_count" percent="4">
            <x-slot name="icon">
                <svg class="h-16 w-20 text-gray-300" stroke="currentColor" stroke-width="2" fill="none"
                    stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full"
                                                ...
                                                alt="Alex Shatov" width="40" height="40"></div>
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full"
                                                ...
                                                alt="Philip Harbach" width="40" height="40"></div>
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full"
                                                ...
                                                alt="Mirko Fisuk" width="40" height="40"></div>
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full"
                                                ...
                                                alt="Olga Semklo" width="40" height="40"></div>
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full"
                                                ...
                                                alt="Burak Long" width="40" height="40"></div>
        ...
        <div class="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
            ...
            <div class="p-3">
                <div>
                    <header class="text-xs uppercase text-gray-400 bg-gray-50 rounded-sm font-semibold p-2">Today
                    </header>
                    <ul class="my-1">
                        <li class="flex px-2">
                            <div class="w-9 h-9 rounded-full flex-shrink-0 bg-orange-500 my-2 mr-3"><svg
                                    class="w-9 h-9 fill-current text-orange-50" viewBox="0 0 36 36">
                                    <path
                            ...
                            <div class="flex-grow flex items-center border-b border-gray-100 text-sm py-2">
                                <div class="flex-grow flex justify-between">
                                    <div class="self-center"><a class="font-medium text-gray-800 hover:text-gray-900"
                                            href="#0" style="outline: currentcolor none medium;">Nick Mark</a> mentioned
                                        <a class="font-medium text-gray-800" href="#0"
                                            style="outline: currentcolor none medium;">Sara Smith</a> in a new post
                                    </div>
                                    <div class="flex-shrink-0 self-end ml-2"><a
                                            class="font-medium text-orange-500 hover:text-orange-600" href="#0"
                                            style="outline: currentcolor none medium;">View<span
                                                class="hidden sm:inline"> -&gt;</span></a></div>
                                </div>
                            </div>
                        </li>
                        <li class="flex px-2">
                            <div class="w-9 h-9 rounded-full flex-shrink-0 bg-red-500 my-2 mr-3"><svg
                                    class="w-9 h-9 fill-current text-red-50" viewBox="0 0 36 36">
                                    <path d="M25 24H11a1 1 0 01-1-1v-5h2v4h12v-4h2v5a1 1 0 01-1 1zM14 13h8v2h-8z">
                                    </path>
                                </svg></div>
                            <div class="flex-grow flex items-center border-b border-gray-100 text-sm py-2">
                                <div class="flex-grow flex justify-between">
                                    <div class="self-center">The post <a class="font-medium text-gray-800" href="#0"
                                            style="outline: currentcolor none medium;">Post Name</a> was removed by <a
                                            class="font-medium text-gray-800 hover:text-gray-900" href="#0"
                                            style="outline: currentcolor none medium;">Nick Mark</a></div>
                                    <div class="flex-shrink-0 self-end ml-2"><a
                                            class="font-medium text-orange-500 hover:text-orange-600" href="#0"
                                            style="outline: currentcolor none medium;">View<span
                                                class="hidden sm:inline"> -&gt;</span></a></div>
                        ...
                        <li class="flex px-2">
                            <div class="w-9 h-9 rounded-full flex-shrink-0 bg-green-500 my-2 mr-3"><svg
                                    class="w-9 h-9 fill-current text-green-50" viewBox="0 0 36 36">
                                    <path
                            ...
                            <div class="flex-grow flex items-center text-sm py-2">
                                <div class="flex-grow flex justify-between">
                                    <div class="self-center"><a
                                            class="font-medium text-gray-800 hover:text-gray-900" href="#0"
                                            style="outline: currentcolor none medium;">Patrick Sullivan</a> published a
                                        new <a class="font-medium text-gray-800" href="#0"
                                            style="outline: currentcolor none medium;">post</a></div>
                                    <div class="flex-shrink-0 self-end ml-2"><a
                                            class="font-medium text-orange-500 hover:text-orange-600" href="#0"
                                            style="outline: currentcolor none medium;">View<span
                                                class="hidden sm:inline"> -&gt;</span></a></div>
                ...
                <div>
                    <header class="text-xs uppercase text-gray-400 bg-gray-50 rounded-sm font-semibold p-2">Yesterday
                    </header>
                    <ul class="my-1">
                        <li class="flex px-2">
                            <div class="w-9 h-9 rounded-full flex-shrink-0 bg-light-blue-500 my-2 mr-3"><svg
                                    class="w-9 h-9 fill-current text-light-blue-50" viewBox="0 0 36 36">
                                    <path
                            ...
                            <div class="flex-grow flex items-center border-b border-gray-100 text-sm py-2">
                                <div class="flex-grow flex justify-between">
                                    <div class="self-center"><a
                                            class="font-medium text-gray-800 hover:text-gray-900" href="#0"
                                            style="outline: currentcolor none medium;">240+</a> users have subscribed to
                                        <a class="font-medium text-gray-800" href="#0"
                                            style="outline: currentcolor none medium;">Newsletter #1</a>
                                    </div>
                                    <div class="flex-shrink-0 self-end ml-2"><a
                                            class="font-medium text-orange-500 hover:text-orange-600" href="#0"
                                            style="outline: currentcolor none medium;">View<span
                        ...
                        <li class="flex px-2">
                            ...
                            <div class="flex-grow flex items-center text-sm py-2">
                                <div class="flex-grow flex justify-between">
                                    <div class="self-center">The post <a class="font-medium text-gray-800"
                                            href="#0" style="outline: currentcolor none medium;">Post Name</a> was
                                        suspended by <a class="font-medium text-gray-800 hover:text-gray-900" href="#0"
                                            style="outline: currentcolor none medium;">Nick Mark</a></div>
                                    <div class="flex-shrink-0 self-end ml-2"><a
                                            class="font-medium text-orange-500 hover:text-orange-600" href="#0"
                                            style="outline: currentcolor none medium;">View<span
