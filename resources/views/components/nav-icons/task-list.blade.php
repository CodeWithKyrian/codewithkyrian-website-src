    ...
    <a class="block text-ash-200 transition duration-150 hover:text-ash-200 active" href="{{ \Illuminate\Support\Facades\Route::has($route)? route($route) : 'javascript:void(0)' }}" style="outline: currentcolor none medium;">
        <div class="flex flex-grow items-center">
            <svg class="flex-shrink-0 h-5 w-5 mr-3" viewBox="0 0 24 24">
                <path @class(['fill-current', 'text-red-600'=> $active, 'text-ash-600' => !$active]) d="M8 1v2H3v19h18V3h-5V1h7v23H1V1z"></path>
                <path @class(['fill-current', 'text-red-600'=> $active, 'text-ash-600' => !$active]) d="M1 1h22v23H1z"></path>
                <path @class(['fill-current', 'text-red-200'=> $active, 'text-ash-400' => !$active]) d="M15 10.586L16.414 12 11 17.414 7.586 14 9 12.586l2 2zM5 0h14v4H5z"></path>
            </svg>
